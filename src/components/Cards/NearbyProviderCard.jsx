...
const NearbyProviderCard = ({ provider, isBookmark, handleRemoveBookMark }) => {
  ...
  const isRTL = useRTL();
  console.log(provider?.is_verified)
  return (

                ...
                <div className="rounded-[18px] bg-[#F5FAFF] dark:card_bg shadow-sm border border-gray-200">
                  <div className="relative overflow-hidden p-6 pb-0">
                    ...
                    {providerData?.is_ensured === "1" && (
                      <div className="absolute z-20 right-[35px] top-[30px] flex items-center gap-1 bg-[#F5FAFF] py-1 px-2 rounded-full">
                        <svg
                          width="50"
                          height="50"
                          viewBox="0 0 50 50"
                          ...
                          className="md:h-[10px] md:w-[10px] h-[10px] w-[10px]"
                        >
                          <path
                        ...
                        <span className=" font-semibold text-[#0EA02E] flex justify-center items-center text-xs">
                          {t("Insured")}
                        </span>
                      </div>
                    )}
